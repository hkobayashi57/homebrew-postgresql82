...
class Postgresql82 < Formula
  ...
  url 'http://ftp.postgresql.org/pub/source/v8.2.23/postgresql-8.2.23.tar.bz2'
  sha256 '56c2ac7394e8ace9ef98a464d08530b91529fd56978f24b55139d20e3039f2d1'
  ...
  def patches
    DATA unless build.include? 'without-ossp-uuid' and build.include? 'no-python'
  end
